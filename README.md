...
This step runs the YOLO model over the input footage frame by frame and writes detection results to the output directory.
...
This step will associate detections across multiple frames using IoU-based tracking.
